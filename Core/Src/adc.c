...
void adc_JoystickGetter (uint16_t* joystick_adc)
{
	joystick_adc[0] = raw_adc[2]; // JOYSTICK X
	joystick_adc[1] = raw_adc[1]; // JOYSTICK Y
}


void adc_PotentiometerGetter (uint16_t* potentiometer_adc)
{
	*potentiometer_adc = raw_adc[0];
}
